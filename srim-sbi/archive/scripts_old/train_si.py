...
# --------------------------------------------------------------------------
RAW_CSV = Path(
    "/Users/cbharathulwar/Documents/Research/Walsworth/Code/SBI/srim-sbi/data/nov3srim/vacancies.csv"
)
...
N_PER_ENERGY = 200 # test tracks per energy

# Use keV consistently for SBI training and conditioning
PRIOR_LOW, PRIOR_HIGH = [0.5], [105]  # keV
